...
import Pic1 from './Books/SJ.jpg';
import Pic2 from './Books/GITW.jpg';
import './BookCard.css';

const Technology = () => {
    return (
        <div>
            <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 d-flex" style={{ justifyContent: "center", position: "absolute", top: "30%", left: "18%" }}>
                <div className="col">
                    <div className="card shadow-sm">
                        <br />
                        <img data-bs-toggle="modal" data-bs-target="#book1" src={Pic1} width="58%" height="56.4%" alt="" style={{ alignSelf: "center" }} />
                                        ...
                                        Books.filter(book => {
                                            ...
                                            <div className="details" key={index}>
                                                ...
                                                <div className="modal-body">
                                                    <div className="Book1">
                                                        <img src={Pic1} alt="" width="40%" height="56.4%" />
                ...
                <div className="col">
                    <div className="card shadow-sm">
                        <br />
                        <img data-bs-toggle="modal" data-bs-target="#book2" src={Pic2} width="59.7%" height="50%" alt="" style={{ alignSelf: "center" }} />
                                ...
                                <div className="modal-content">
                                    {
                                        Books.filter(book => {
                                            ...
                                            <div className="details" key={index}>
                                                ...
                                                <div className="modal-body">
                                                    <div className="Book2">
                                                        <img src={Pic2} alt="" width="40%" height="50%" />
                                                        <br /><br />
                                                        <div className="description">
                                                            <h2>{book.Name}</h2>
                                                            <small>Product ID: {book.id}</small>
