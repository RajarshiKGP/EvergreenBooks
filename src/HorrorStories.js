...
import Pic1 from './Books/THOHH.jpg';
import Pic2 from './Books/F.jpg';
import './BookCard.css';
            ...
            <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 d-flex" style={{ justifyContent: "center", position: "absolute", top: "30%" }}>
                <div className="col">
                    <div className="card shadow-sm">
                        <br />
                        <img data-bs-toggle="modal" data-bs-target="#book1" src={Pic1} width="42%" height="56.4%" alt="" style={{ alignSelf: "center" }} />
                    ...
                    <div className="Modals">
                        <div className="modal fade" id="book1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style={{ position: "absolute", top: "-3vh" }}>
                                        ...
                                        Books.filter(book => {
                                            ...
                                            <div className="details" key={index}>
                                                ...
                                                <div className="modal-body">
                                                    <div className="Book1">
                                                        <img src={Pic1} alt="" width="42%" height="56.4%" />
                ...
                <div className="col">
                    <div className="card shadow-sm">
                        <br />
                        <img data-bs-toggle="modal" data-bs-target="#book2" src={Pic2} width="39.5%" height="50%" alt="" style={{ alignSelf: "center" }} />
                                ...
                                <div className="modal-content">
                                    {
                                        Books.filter(book => {
                                            ...
                                            <div className="details" key={index}>
                                                ...
                                                <div className="modal-body">
                                                    <div className="Book2">
                                                        <img src={Pic2} alt="" width="39.5%" height="50%" />
                                                        <br /><br />
                                                        <div className="description">
                                                            <h2>{book.Name}</h2>
                                                            <small>Product ID: {book.id}</small>
