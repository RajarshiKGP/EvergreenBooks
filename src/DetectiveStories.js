...
import Pic1 from './Books/SH.jpg';
import Pic2 from './Books/TBC.jpg';
import './BookCard.css';

const DetectiveStories = () => {
    return (
        <div>
            <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 d-flex" style={{ justifyContent: "center", position: "absolute", top: "30%" }}>
                <div className="col">
                    <div className="card shadow-sm">
                        <img data-bs-toggle="modal" data-bs-target="#book1" src={Pic1} width="61%" height="61%" alt="" style={{ alignSelf: "center" }} />
