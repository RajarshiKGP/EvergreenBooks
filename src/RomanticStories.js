...
import Pic1 from './Books/FIOS.jpg';
import Pic2 from './Books/TTB.jpg';
import './BookCard.css';
            ...
            <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 d-flex" style={{ justifyContent: "center", position: "absolute", top: "30%" }}>
                <div className="col">
                    <div className="card shadow-sm">
                        <br />
                        <img data-bs-toggle="modal" data-bs-target="#book1" src={Pic1} width="40.5%" height="56.4%" alt="" style={{ alignSelf: "center" }} />
                                        ...
                                        Books.filter(book => {
                                            ...
                                            <div className="details" key={index}>
                                                ...
                                                <div className="modal-body">
                                                    <div className="Book1">
                                                        <img src={Pic1} alt="" width="40.5%" height="56.4%" />
